                ...
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <thead>
                        <tr class="bg-navy disabled" style="">
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Cant</th>
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Unidad</th>
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Producto</th>
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Descripción</th>
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Precio</th>
