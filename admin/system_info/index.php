	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="company_email" class="control-label">Correo de la Empresa</label>
				...
				<div class="form-group">
					<label for="company_address" class="control-label">Dirección de Empresa</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Portada Inicio</label>
				<div class="custom-file">
