...
<form action="" id="supplier-form">
    ...
    <div class="container-fluid">
        ...
        <div class="form-group">
            <label for="contact_person" class="control-label">Contacto Personal</label>
        ...
        <div class="form-group">
            ...
            <select name="status" id="status" class="form-control rounded-0" required>
                <option value="1" <?php echo isset($status) && $status =="" ? "selected": "1" ?> >Activo</option>
                <option value="0" <?php echo isset($status) && $status =="" ? "selected": "0" ?>>Inactivo</option>
            </select>
        </div>
    </div>
</form>
